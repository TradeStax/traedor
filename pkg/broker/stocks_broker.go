...
func NewStocksBroker(c *config.BrokerConfig) IBroker {
	return &StocksBroker{
		account: Account{
...
func (b *StocksBroker) GetAccountStats() (Account, error) {
	return b.account, nil
}

func (b *StocksBroker) SendTrade(t Trade) error {
	switch t.Operation {
	case Close:
...
func (b *StocksBroker) updateBalance(t Trade) {
	var net float64
...
func (b *StocksBroker) validTrade(t *Trade) bool {
