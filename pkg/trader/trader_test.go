...
func TestTrader_CalculatePerformanceMetrics(t *testing.T) {
...
func TestTrader_CalculateDrawdownHistory(t *testing.T) {
	trader := newTestTrader()
...
func TestTrader_CalculatePerformanceMetrics_NoTrades(t *testing.T) {
	trader := newTestTrader()
