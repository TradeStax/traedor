      ...
      <div className="space-y-6">
        ...
        {process.env.NODE_ENV === 'development' && (
          <div className="bg-yellow-100 p-4 rounded">
            <p>Debug - Pagination data: {JSON.stringify(pagination)}</p>
            <p>Debug - Page size: {pageSize}</p>
            <p>Debug - Should show pagination: {pagination && pagination.total > 0 && pagination.total > pageSize ? 'YES' : 'NO'}</p>
          </div>
        )}
